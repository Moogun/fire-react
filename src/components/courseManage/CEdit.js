...
//     // console.log('did mount 1 ', 'afterIsLoading')
...
//     //       .then(user => {
//     //         console.log('did mount 2 user', user.val().courseTeaching[courseId].metadata);
//     //
//     //         const {isLoading } = this.state
//     //         // console.log('did mount 4 isLoading', isLoading);
//     //
//     //         // this.setState({isLoading: !isLoading})
//     //
//     //         this.setState ({
